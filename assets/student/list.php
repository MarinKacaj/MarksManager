...
$studentInstances = Student::getBuilder()->getList();
$isEmpty = false;
if (empty($studentInstances)) {
    $isEmpty = true;
    array_push($studentInstances, Student::getBuilder()->createEmpty());
}
$listViewAggregator = new ListViewAggregator($studentInstances);
?>
...
<div class="container">
    <div class="well text-center" id="mainTitle"><h4>Student&euml;</h4></div>
    <div class="row">
