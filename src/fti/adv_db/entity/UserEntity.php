...
abstract class UserEntity extends BasicEntity
{
    ...
    public function __construct($params)
    {
        ...
        $isCreate = $id === BasicEntity::UNSAVED_INSTANCE_ID;
        $this->properties[self::PROP_PASSWORD] = new StringProperty(self::PROP_PASSWORD, 'Password', $params[self::PROP_PASSWORD], $isCreate, true);
    }
    ...
    {
        parent::unsetProperty(self::PROP_PASSWORD);
    }
